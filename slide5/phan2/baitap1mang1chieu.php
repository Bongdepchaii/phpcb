...
<head>
    ...
    <title>Chi tiet san pham <?php echo $product['name']; ?></title>
    <style>
        table {
            width: 100%;
        ...
        <table>
            ...
            <?php foreach ($product as $field => $value): ?>
                <tr>
                    ...
                    <td>
                        <?php if ($field == 'image'): ?>
                            <img src="<?php echo $value; ?>" width="100px">
                        <?php else: ?>
                            <?php echo $value; ?>
                        <?php endif; ?>
                    </td>
